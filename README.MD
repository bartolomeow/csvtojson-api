...
[localhost/api/csvtojson/1column](http://localhost/api/csvtojson/1column)\
Para archivos CSV multicolumna: [localhost/api/csvtojson](http://localhost/api/csvtojson)
